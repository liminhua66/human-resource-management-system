      ...
      <div class="block">
        ...
        <el-form-item label="转正状态">
          <el-select v-model="formData.stateOfCorrection" placeholder="请选择" disabled>
            <el-option
              v-for="item in EmployeeNum.stateOfCorrection"
              :key="item.value"
              :value="item.value"
            />
          </el-select>
      ...
      <div class="block">
        ...
        <el-form-item label="合同期限">
          <el-select v-model="formData.contractPeriod" class="filter-item">
            <el-option
              v-for="item in EmployeeNum.contractPeriod"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            />
        ...
        <el-form-item label="续签次数">
          <el-select v-model="formData.renewalNumber" class="filter-item">
            <el-option
              v-for="item in EmployeeNum.renewalCount"
              :key="item.id"
              :label="item.value"
              :value="item.id"
            />
      ...
      <div class="block">
        ...
        <el-form-item label="其他招聘渠道">
          <el-select v-model="formData.otherRecruitmentChannels" placeholder="请选择">
            <el-option
              v-for="item in EmployeeNum.resumeSource"
              :key="item.id"
              :label="item.value"
              :value="item.value"
            />
        ...
        <el-form-item label="社招/校招">
          <el-select v-model="formData.socialRecruitment" placeholder="请选择">
            <el-option
              v-for="item in EmployeeNum.hireSourceType"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            />
